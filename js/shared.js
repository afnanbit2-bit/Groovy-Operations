...
function _updateMobNavActive(pageId){
  ...
  const groups={
    ...
    'activity':'more','monitor':'more','users':'more','bug-tracker':'more','shopify-intel':'more','fulfillment':'more','pattern-hub':'more','pattern-reconcile':'more','pattern-blocks':'more','pattern-block':'more','pattern-unassigned':'more','pattern-poms':'more',
...
const BUG_PAGE_NAMES={
  ...
  'pattern-poms':'Pattern Hub · Points of measure',
